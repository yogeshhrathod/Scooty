        ...
        <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-6 max-w-2xl">
                <motion.div
                    ...
                    className="w-24 h-24 bg-muted border border-border rounded-3xl flex items-center justify-center mb-8 shadow-2xl shadow-primary/20"
                >
                ...
                <motion.button
                    ...
                    className="group relative px-8 py-4 bg-foreground text-background rounded-full font-bold text-lg flex items-center gap-3 shadow-xl hover:opacity-90 transition-all"
                >
                    Get Started
            ...
            <motion.div
                ...
                className="absolute bottom-8 text-muted-foreground/50 text-sm font-mono"
            >
