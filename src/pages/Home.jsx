            ...
            <div className="relative z-10 w-full">
                ...
                {displayItems.length > 0 && (
                    <div className="mb-12">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 3xl:grid-cols-10 4k:grid-cols-12 gap-4 md:gap-6 px-4 mt-8">
                ...
                {/* Movies Section */}
                {moviesOnly.length > 0 && (
                    <div className="mt-12 mb-8 ps-4">
                        <h2 className="text-2xl font-semibold text-neutral-900 dark:text-white mb-6 pl-2 border-l-4 border-primary">
                            Recent Movies
                        </h2>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 3xl:grid-cols-10 4k:grid-cols-12 gap-4 md:gap-6 px-4">
                ...
                {tvShowsOnly.length > 0 && (
                    <div className="mt-12 mb-8 ps-4">
                        <h2 className="text-2xl font-semibold text-neutral-900 dark:text-white mb-6 pl-2 border-l-4 border-orange-500">
                            TV Shows
                        </h2>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 3xl:grid-cols-10 4k:grid-cols-12 gap-4 md:gap-6 px-4">
                ...
                {displayItems.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-[50vh] text-center w-full">
                        <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 pb-4">
                            Welcome to Scooty
                        </h1>
                        ...
                        <button
                            ...
                            className="mt-8 px-6 py-3 bg-primary rounded-full text-white font-medium hover:bg-primary/80 transition-colors"
                        >
                            Go to Settings
                        </button>
                    </div>
