        ...
        if (this.state.hasError) {
            return (
                <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground p-6 text-center select-none">
                    <div className="w-20 h-20 bg-destructive/10 rounded-3xl flex items-center justify-center mb-6 animate-pulse">
                    ...
                    <div className="bg-muted/30 p-4 rounded-xl border border-border w-full max-w-lg mb-8 text-left font-mono text-xs overflow-auto max-h-48">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-foreground text-background rounded-xl font-bold hover:opacity-90 transition active:scale-95"
                    >
